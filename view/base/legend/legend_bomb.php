        ...
        <div class="<?= ($colorId==\entities\Base::BASE_RED) ? 'background-red' : 'background-blue' ?>">
            ...
            <div class="info-left">
                <div class="element">
                    ...
                    <div class="text-info">
                        <p class="margin-bottom">Диверсия
                        </p>
                    </div>
                </div>
                ...
                <div class="element">
                    ...
                    <div class="text-info">
                        ...
                        Взорвать определенные постройки.
                        </p>
                    </div>
                </div>
                ...
                <div class="element">
                    ...
                    <div class="text-info">
                        <p class="margin-bottom">
                            Игрок получает бомбу на базе, несет, устанавливает на дом, дом взрывается. 
                            <br>Противник может обезвредить бомбу - выстрелив в дом.
                        </p>
                    </div>
                </div>
