        ...
        <div class="<?= ($colorId==\entities\Base::BASE_RED) ? 'background-red' : 'background-blue' ?>">
            ...
            <div class="info-left">
                <div class="element">
                    ...
                    <div class="text-info">
                        <p class="margin-bottom">Накопление времени
                        </p>
                    </div>
                </div>
                ...
                <div class="element">
                    ...
                    <div class="text-info">
                        <p class="margin-bottom">Удержать контрольные точки определенное количество времени своим цветом.
                        </p>
                    </div>
                </div>
                ...
                <div class="element">
                    ...
                    <div class="text-info">
                        <p class="margin-bottom">
                            При перехвате точки противником время, накопленное вами, сохраняется.
